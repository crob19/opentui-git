...
// Handle CLI flags before importing JSX (which triggers module resolution)
...
// Dynamic import to defer JSX module resolution
const { render } = await import("@opentui/solid");
const { App } = await import("./app.js");
const { Clipboard } = await import("./utils/clipboard.js");
